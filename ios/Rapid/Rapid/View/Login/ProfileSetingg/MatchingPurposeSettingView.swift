//
//  MatchingPurposeSettingView.swift
//  Rapid
//
...
struct MatchingPurposeSettingView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .center, spacing: .zero) {
                ...
                ScrollView(.vertical) {
                    VStack {
                        ForEach(profileLoginSettingViewModel.matchingPurposeList) { purpose in
                            Button(action: {
                                withAnimation {
                                    profileLoginSettingViewModel.selectedPurpose = purpose
                                }
                            }) {
                                HStack {
                                    Spacer()
                                    Text(purpose.purpose.rawValue)
                                        .font(.headline)
                                        .foregroundStyle(profileLoginSettingViewModel.selectedPurpose == purpose ? .white : .gray)
                                    Spacer()
                                }
                                .padding()
                                .background {
                                    if profileLoginSettingViewModel.selectedPurpose == purpose {
